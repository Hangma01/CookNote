...
// 베스트 레시피 가져오기 - 메인
export const getBestRecipe = async () => {
    return await publicAPI.get(`/recipe/best`);
};

// 혼밥 레시피 가져오기 - 메인
export const getSoloRecipe = async () => {
    return await publicAPI.get(`/recipe/solo`);
};

// 최신 레시피 가져오기 - 메인
export const getRecentRecipe = async () => {
    return await publicAPI.get(`/recipe/recent`);
};
